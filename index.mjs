...
app.get('/screenshot/:choosenDate/:cutie/:screenshot', (req, res) => { 
    console.log(req.params.choosenDate, req.params.cutie, req.params.screenshot);
    res.download(path.join('..', 'cuties', req.params.choosenDate, req.params.cutie, "screenshots", req.params.screenshot)); 
});
